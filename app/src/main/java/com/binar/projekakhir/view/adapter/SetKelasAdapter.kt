...
class SetKelasAdapter (private val listKelas:List<KelasDummy>,
    private val listener:OnItemClickListener
        ...
        override fun onCreateViewHolder(
                parent: ViewGroup,
                viewType: Int
        ): SetKelasAdapter.ViewHolder {
                val itemView = LayoutInflater.from(parent.context)
                        .inflate(R.layout.item_set_kelas, parent, false)
        ...
        override fun onBindViewHolder(holder: SetKelasAdapter.ViewHolder, position: Int) {
                ...
                if (listKelas[position].isSelected) {
                        holder.itemView.findViewById<View>(R.id.succes_klik).visibility =
                                View.VISIBLE
                        holder.itemView.findViewById<ConstraintLayout>(R.id.layout_set_kelas)
                        holder.itemView.findViewById<TextView>(R.id.tv_class)
                                .setTextColor(holder.itemView.resources.getColor(R.color.white))
                        holder.itemView.findViewById<TextView>(R.id.tv_price)
                                .setTextColor(holder.itemView.resources.getColor(R.color.white))
                } else {
