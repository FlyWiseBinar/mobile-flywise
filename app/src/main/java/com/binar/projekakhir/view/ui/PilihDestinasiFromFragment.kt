...
import com.binar.projekakhir.databinding.FragmentPilihDestinasiFromBinding
import com.binar.projekakhir.model.searchairport.data
import com.binar.projekakhir.view.adapter.PencarianFromAdapter
...
@AndroidEntryPoint
class PilihDestinasiFromFragment : Fragment() {

    private lateinit var binding : FragmentPilihDestinasiFromBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPilihDestinasiFromBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun showSearch(context: Context, dataAirport: List<data>) {
        val searchAdapter = PencarianFromAdapter(context, dataAirport)
