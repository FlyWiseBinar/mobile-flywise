...
class RiwayatPencarianAdapter (private val context: Context, private val dat: List<String>) :
    RecyclerView.Adapter<RiwayatPencarianAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_riwayat_pencarian, parent, false)
